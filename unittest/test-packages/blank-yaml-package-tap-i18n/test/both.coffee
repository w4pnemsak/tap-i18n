Tinytest.add 'blank-package-tap-i18n - TAPi18n.packages generated correctly', (test) ->
  test.equal Package["w4pnemsak:i18n"].TAPi18n.packages, {"tap-tests:blank-yaml-package-tap-i18n":{"translation_function_name":"__","helper_name":"_","namespace":"tap-tests:blank-yaml-package-tap-i18n"}}
