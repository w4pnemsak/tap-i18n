Tinytest.add 'custom-package-tap-i18n - TAPi18n.packages generated correctly', (test) ->
  test.equal Package["w4pnemsak:i18n"].TAPi18n.packages, {"tap-tests:custom-package-tap-i18n":{"translation_function_name":"i18n_func","helper_name":"i18n_helper","namespace":"tap-tests:blank-package-tap-i18n"}}
